...
static const uint8_t char1_name[]  = "Write Read Data MQTT";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
                {
                    ...
                    [IDX_CHAR_VAL_A] =
                    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&CHAR_1_SHORT_WR, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
    ...
    //#endif
        ...
        case ESP_GATTS_READ_EVT:
            ...
            if(gatt_db_handle_table[IDX_CHAR_VAL_A] == param->read.handle) {
                ESP_LOGE(EXAMPLE_TAG, "***** read mqtt ***** \n");
            }
       	    break;
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                if(gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle) {
                    ESP_LOGI(EXAMPLE_TAG, "BLE_WRITE_DATA");
                    printf("DATA=%.*s\r\n", param->write.len, param->write.value);
                    int msg_id;
                    msg_id = esp_mqtt_client_publish(client, "esp32ahaha", (char *)param->write.value, 0, 0, 0);
...
static esp_err_t mqtt_event_handler_cb(esp_mqtt_event_handle_t event)
{
    ...
    switch (event->event_id) {
        case MQTT_EVENT_CONNECTED:
            ...
            msg_id = esp_mqtt_client_subscribe(client, "esp32ahaha", 0);
        ...
        case MQTT_EVENT_DATA:
            ...
            esp_ble_gatts_set_attr_value(gatt_db_handle_table[IDX_CHAR_VAL_A], event->data_len, (uint32_t *)event->data);
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        .host = "mqtt.flespi.io",
        .port = 1883,
        .username = "FlespiToken yn3T1VzTXVp1O4Tmm80xywarhrlUTgihtc0kVp1G8exL9fVjbJHz6FQbWZVF54Mn",
        .client_id = "123",
    };
